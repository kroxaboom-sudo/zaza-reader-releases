...
| Масштабирование и полоса прокрутки | Загрузка только по Wi-Fi или через мобильную сеть |
| Сохранение позиции и общая история | Импорт закладок после входа в аккаунт |
