...
Приложение активно развивается. **Preview** в названии означает тестовую сборку. Версия 0.6.16 проверена в эмуляторах Android 9 и 13; это не гарантирует одинаковую работу на всех устройствах.
